  ...
  return (
    <ConfigProvider theme={theme === 'light' ? lightTheme : darkTheme}>
      <ThemeProvider theme={theme === 'light' ? lightTheme : darkTheme}>
        <Routes>
          <Route path={routes.login} element={isLoggedIn ? <Navigate to="/" replace /> : <LoginPage />} />
          <Route path={routes.home} element={isLoggedIn ? (<Layout />) : (<Navigate to="/login" replace state={{ from: location }} />)}>
